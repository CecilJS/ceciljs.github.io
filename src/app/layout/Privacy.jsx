          ...
          <AnimatedGrid style={style} container>
            <Grid item xs={10} sm={10} md={8} lg={8} xl={8}>
              ...
              <Typography variant="body1" sx={{ mt: 2 }}>
                Last updated: September 29, 2020 This Privacy Policy describes Our policies and
                procedures on the collection, use and disclosure of Your information when You use
                the Service and tells You about Your privacy rights and how the law protects You. We
              ...
              <Typography variant="body1" sx={{ mt: 1 }}>
                For the purposes of this Privacy Policy: Account means a unique account created for
                You to access our Service or parts of our Service. Company (referred to as either
                "the Company", "We", "Us" or "Our" in this Agreement) refers to
                Ceciljs.herokuapps.com. Cookies are small files that are placed on Your computer,
                mobile device or any other device by a website, containing the details of Your
                browsing history on that website among its many uses. Country refers to: United
                Kingdom Device means any device that can access the Service such as a computer, a
                cellphone or a digital tablet.
              </Typography>
              <Typography variant="body1" sx={{ mt: 1 }}>
                Personal Data is any information that relates to an identified or identifiable
                individual. Service refers to the Website. Service Provider means any natural or
              ...
              <Typography variant="body1" sx={{ mt: 1 }}>
                ...
                through which a User can log in or create an account to use the Service. Usage Data
                ...
                visit). Website refers to Ceciljs.herokuapps.com, accessible from
                Ceciljs.herokuapps.com. You means the individual accessing or using the Service, or
              ...
              <Typography variant="body1" sx={{ mt: 3, fontWeight: 'bold' }}>
                ...
                address First name and last name Usage Data
              </Typography>
              <Typography variant="h5" sx={{ mt: 1 }}>
              ...
              <Typography variant="body1" sx={{ mt: 1 }}>
                ...
                enforce our legal agreements and policies. The Company will also retain Usage Data
              ...
              <Typography variant="body1" sx={{ mt: 1 }}>
                ...
                necessary to: Comply with a legal obligation Protect and defend the rights or
                property of the Company Prevent or investigate possible wrongdoing in connection
              ...
              <Typography variant="body1" sx={{ mt: 1 }}>
                ...
                effective and update the Last updated date at the top of this Privacy Policy. You
              ...
              <Typography variant="body1" sx={{ mt: 1 }}>
                If you have any questions about this Privacy Policy, You can contact us using the
