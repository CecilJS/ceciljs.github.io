...
function Contact(){
    ...
    return(
        ...
        <Grid item xs={12} sm={12} md={6} lg={6} xl={6} >
            <Typography variant='h2' sx={{ ml:20}}>
            Contact me
            </Typography>
            <Typography variant='h6' sx={{ ml:20, mt: 3}} >
             ...
             <TwitterIcon sx={{ ml: 20, mt: 3}}/>
             <Typography variant='h5' sx={{ ml:20, mt: 5, fontWeight: 'bold'}} >
                    Would you like to see some of my projects?
             </Typography>
                <Button variant="contained" sx={{ ml:20, mt: 5, fontWeight: 'bold', bgcolor: "#003333"}}>Projects</Button>
                </Grid>
